...
==============================================================================*/
package org.chineseglue.android_transformers.bertqa.ml;
...
import org.chineseglue.android_transformers.bertqa.chinese_tokenization.FullTokenizer;
...
public final class FeatureConverter {
  ...
  public FeatureConverter(
    ...
    this.tokenizer = new FullTokenizer(inputDic);
...
*/
    ...
    //List<String> origTokens = context.toCharArray();

    ArrayList<String> origTokens = new ArrayList<String>();
